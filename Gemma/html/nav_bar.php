            ...
            <ul class="navbar-nav w-75 justify-content-between">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu custom-dropdown" style="background-color: #E2CBCB;margin-top: 3px;" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="products_desktop.php">Jednoduché</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu custom-dropdown" style="background-color: #E2CBCB;margin-top: 3px;" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="products_desktop.php">Puzetkové náušnice</a></li>
                        <li><a class="dropdown-item" href="products_desktop.php">Kruhové náušnice</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu custom-dropdown" style="background-color: #E2CBCB;margin-top: 3px;" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="products_desktop.php">Retiazkové náhrdelníky</a></li>
                        <li><a class="dropdown-item" href="products_desktop.php">S príveskom</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu custom-dropdown" style="background-color: #E2CBCB;margin-top: 3px;" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="products_desktop.php">Pevné náramky</a></li>
                        <li><a class="dropdown-item" href="products_desktop.php">Retiazkové náramky</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu custom-dropdown" style="background-color: #E2CBCB;margin-top: 3px;" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="products_desktop.php">Minimalistic</a></li>
                        <li><a class="dropdown-item" href="products_desktop.php">Eternal</a></li>
